...
private:
	...
	vec3	pixel_delta_u;
	vec3	pixel_delta_v;
	vec3	u, v, w;			//camera frame basis vectors or camera tf vectors
	...
	void intialize()
	{
		...
		auto h = std::tan(theta / 2);		//half height of viewport
		auto viewport_height = 2 * h * focus_dist;
		auto viewport_width = viewport_height * (double(img_width) / img_height);

		//calculating u,v,w unit basis vectors for cam coordinate frame
